...
"$CXX" -shared -o "$OUT" \
  build/gen/winmm.def \
  src/fix.cpp src/bloom_hook.cpp src/detour.cpp src/dxbc_patch.cpp src/engine_probe.cpp src/frame_overlay.cpp src/frustum_fix.cpp src/grass.cpp src/hdr.cpp src/probe.cpp src/shadow_fix.cpp src/streaming.cpp src/upload.cpp src/visual.cpp \
