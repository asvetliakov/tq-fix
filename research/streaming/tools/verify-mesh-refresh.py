...
for name,rva in [('kActorWindow',0x114f07),('kEntityHead',0x148050),('kEntityTail',0x1480c3),('kTouched',0x2130c0),('kFrame',0x146cd0)]:
...
for name,rva,size in [('kTestActor',0x114f00,49),('kTestEntity',0x148050,131)]:
 out+='const BYTE '+name+'[] = {\n'
...
print('PASS: mesh preload call site, native accessors, exports and executable Actor/Entity fixtures')
