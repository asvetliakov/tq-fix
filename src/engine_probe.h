...
// Optional audited Engine instrumentation. Performance behavior lives in
// shadow_defer.cpp, terrain_preload.cpp, secondary_admission.cpp and
// archive_hooks.cpp; engine_hooks.cpp coordinates their shared patch sites.
//
...
// engine::readOptions reads [debug] engine_trace. 0 disables Engine tracing;
// 1 (the default)
